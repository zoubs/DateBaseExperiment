    ...
    public partial class modifygradeFram : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (comboBoxterm.Text != "" && textBoxclass.Text != "")
            {
                ...
                conn.Open();
                string sql = "select Student.Sno as 学生学号,Student.Sname as 学生姓名,SC.Grade as 成绩,Class.Cname as 课程名,Class.Cterm as 学期,Class.Cteacher as 老师 from Class,Student,SC  where Student.Sid=SC.Sid and SC.Cid=Class.Cid and Class.Cterm = '" + comboBoxterm.SelectedItem.ToString() + "'and Class.Cname='" + textBoxclass.Text + "'";
